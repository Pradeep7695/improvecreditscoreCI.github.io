...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart("dashboard/update_testimonial/{$editTestimonialData->id}",['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'client_name','placeholder'=>'client Name','value'=>set_value('client_name',$editTestimonialData->client_name)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<textarea class="ckeditor" id="content" name="client_review"><?= $editTestimonialData->client_review;?></textarea>
							<?= form_error('client_review','<div class="text-danger">','</div>')?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="file" name="client_img" value="" class="file multiple" id="input-b3" data-browse-on-zone-click="TRUE" data-show-upload="false" data-show-caption="true" data-initial-preview="<img width='150' height='150' src='<?= $editTestimonialData->client_img?>'/>"  />
						</div>
					</div>
