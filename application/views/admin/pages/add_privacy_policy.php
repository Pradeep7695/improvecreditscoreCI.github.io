...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/create_policy',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'privacy_title','placeholder'=>'Privacy Policy Title','value'=>set_value('privacy_title')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_textarea(['class'=>'ckeditor','name'=>'privacy_desc','placeholder'=>'Privacy Policy Description','value'=>set_value('privacy_desc')])?>
							<?= form_error('privacy_desc','<div class="text-danger">','</div>')?>
						</div>
					</div>
