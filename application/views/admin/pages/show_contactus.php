				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="contact_us" class="table table-bordered table-striped table-actions">
							...
							<tbody>
							<?php if ($contactData):?>
								<?php foreach ($contactData as $contactData):?>
									<tr>
										...
										<td>
											<?php
											echo anchor("dashboard/edit_contactUs/". $contactData->id,'<button class="btn btn-info btn-condensed"><i class="fa fa-edit"></i></button>');
