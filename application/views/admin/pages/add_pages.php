...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Pages</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/createPages',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'title','placeholder'=>'Title','value'=>set_value('title')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_textarea(['class'=>'ckeditor','name'=>'content','placeholder'=>'Content','value'=>set_value('content')])?>
