...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Credit Score Plan</li>
</ul>

<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Credit Score Plan</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/create_domestic_package',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'domestic_trip_name','placeholder'=>'Package Name','value'=>set_value('domestic_trip_name')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'domestic_price','placeholder'=>'Package Price','value'=>set_value('domestic_price')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'domestic_price','placeholder'=>'Package Discount Price','value'=>set_value('domestic_price')])?>
							<?= form_error('domestic_price','<div class="text-danger">','</div>')?>
						</div>
					</div>
				...
				<!--  	<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'domestic_trip_day','placeholder'=>'ex. 5 DAYS 4 NIGHTS','value'=>set_value('domestic_trip_day')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_textarea(['class'=>'ckeditor','name'=>'domestic_desc','placeholder'=>'Package Description','value'=>set_value('domestic_desc')])?>
					...
					<!--<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'domestic_img'])?>
						</div>
					</div>-->
