...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/create_contact_us',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'contact_no','placeholder'=>'Contact No','value'=>set_value('contact_no')])?>
