...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart("dashboard/update_terms_condition/{$editTerms->id}",['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'term_title','placeholder'=>'Terms & Condition Title','value'=>set_value('term_title',$editTerms->term_title)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<textarea class="ckeditor" id="content" name="term_desc"><?php echo $editTerms->term_desc?></textarea>
						</div>
					</div>
