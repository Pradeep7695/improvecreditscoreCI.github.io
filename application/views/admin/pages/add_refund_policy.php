...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Refund Policy</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/create_refund',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'refund_title','placeholder'=>'Refund Policy Title','value'=>set_value('refund_title')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_textarea(['class'=>'ckeditor','name'=>'refund_desc','placeholder'=>'Refund Policy Description','value'=>set_value('refund_desc')])?>
							<?= form_error('refund_desc','<div class="text-danger">','</div>')?>
						</div>
					</div>
